  ...
  return (
    <footer id="contact" className="border-t border-border bg-foreground">
      <div className="mx-auto max-w-7xl px-4 py-12 lg:px-8 lg:py-16">
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 max-w-xs text-sm leading-relaxed text-background/60">
              Voice-first commerce and mobile money platform for everyday
        ...
        <div className="mt-12 border-t border-background/10 pt-8">
          <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-2">
            ...
            {[
              ...
              <span
                key={tech}
                className="rounded border border-background/10 px-2 py-0.5 text-[10px] font-medium text-background/50"
              >
                {tech}
              </span>
            ))}
        ...
        {/* Bottom Bar */}
        <div className="mt-6 flex flex-col items-center justify-between gap-4 border-t border-background/10 pt-6 md:flex-row">
          <p className="text-sm text-background/40">
            &copy; {new Date().getFullYear()} MRU Merchant OS. All rights reserved.
          </p>
          ...
          <div className="flex items-center gap-4">
            <a
              href="#"
              aria-label="Twitter"
              className="flex h-9 w-9 items-center justify-center rounded-full bg-background/10 text-background/60 transition-colors hover:bg-background/20 hover:text-background"
            >
